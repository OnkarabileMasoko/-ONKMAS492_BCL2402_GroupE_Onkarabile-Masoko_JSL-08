...
//   ensuring that there is only one set of branch information throughout the application.
 ...
 // BankBranch class for managing branch information
class BankBranch {
...
const branchA = new BankBranch("Rusternburg");
const branchB = new BankBranch("Mafikeng");
...
// Verifying that branchA and branchB are referring to the same instance
